...
def specific_user_output():   #вывод конкретного пользователя_1
    '''
    при введении числа 1 вывод конкретного пользователя 
    '''
...
def all_user_output():    #вывод всех пользователя_2
    '''
    при введении числа 2 вывод всех пользователя 
    '''
...
def conduct_an_operation_with_an_account():  #провести операцию со счетом_3
    '''
    при введении числа 3 провести операцию со счетом 
    '''    
    print ('Ведите номер счета')
...
def add_new_user():  #добавить нового пользователя_4
    '''
    при введении числа 4 добавить нового пользователя 
    '''    
...
def delete_user(): #удалить пользователя_5
    '''
    при введении числа 5 удолить пользователя 
    '''    
    del_index = None
...
def exit_the_program(): #выход_6
    '''
    при введении числа 6 выйти из программы 
    '''    
...
def debugger(): #отлодчик_666
    '''
    при введении числа 666 выводиться заготовленные действия из функции отладчика 
    '''    
